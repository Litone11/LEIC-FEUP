 ...
 * - IRQ lines
 * - KBC (Keyboard Controller) registers and status flags
 * - Mouse communication commands and bit masks
 * - Useful scancodes for keyboard events
 * 
 * These constants are used for handling keyboard and mouse input
 * in Minix-based low-level programming.
 * 
