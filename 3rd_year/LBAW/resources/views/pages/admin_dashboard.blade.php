...
<div class="min-h-screen bg-atlas-50">
    ...
    <div class="px-4 sm:px-8 lg:px-12 space-y-6 pb-16">
        ...
        <section class="rounded-3xl border border-slate-200 bg-white">
            <div class="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between px-6 py-4 border-b border-slate-100">
                ...
                <form method="GET"
                      ...
                      class="flex gap-2 mt-2 sm:mt-0 items-center">
                    <input type="hidden" name="tab" value="users">
                    <label for="userSearch" class="sr-only">Pesquisar utilizadores</label>
                    <input type="text"
                           id="userSearch"
                           name="user_search"
                           value="{{ $userSearch ?? '' }}"
                    ...
                    <button type="submit"
                            class="rounded-2xl border border-slate-200 px-4 py-2 text-xs font-semibold text-slate-700 hover:bg-slate-50">
                        Pesquisar
                    </button>
        ...
        @includeWhen($activeTab === 'users', 'partials.admin.admin_new_account_modal')
